...
public class ModLootTableModifiers {
    ...
    private static LootPool.Builder bronzeArmorPool(float chance, float minCount, float maxCount) {
        return LootPool.lootPool()
                ...
                .add(LootItem.lootTableItem(MapleArmorItems.BRONZE_HELMET.get()))
                .add(LootItem.lootTableItem(MapleArmorItems.BRONZE_CHESTPLATE.get()))
                .add(LootItem.lootTableItem(MapleArmorItems.BRONZE_LEGGINGS.get()))
                .add(LootItem.lootTableItem(MapleArmorItems.BRONZE_BOOTS.get()))
                .apply((LootItemFunction.Builder) SetItemCountFunction.setCount(UniformGenerator.between(minCount, maxCount)).build());
    }
    ...
    private static LootPool.Builder powderPool(float chance, float minCount, float maxCount) {
        return LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1))
                .when(LootItemRandomChanceCondition.randomChance(chance))
                .add(LootItem.lootTableItem(GrowableOresItems.BRONZE_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.CLAY_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.COAL_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.COPPER_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.DIAMOND_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.ENERGIUM_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.GOLD_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.IRON_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.LAPIS_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.LEAD_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.LITHIUM_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.OBSIDIAN_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.SILICON_DIOXIDE_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.SILVER_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.STONE_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.SULFUR_DUST.get()))
                .add(LootItem.lootTableItem(GrowableOresItems.TIN_DUST.get()))
                .apply((LootItemFunction.Builder) SetItemCountFunction.setCount(UniformGenerator.between(minCount, maxCount)).build());
    }
    ...
    private static LootPool.Builder iridiumOrePool(float chance, float minCount, float maxCount) {
        return LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1))
                .when(LootItemRandomChanceCondition.randomChance(chance))
                .add(LootItem.lootTableItem(GrowableOresItems.IRIDIUM_ORE.get()))
    ...
    private static LootPool.Builder iridiumShardPool(float chance, float minCount, float maxCount) {
        return LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1))
                .when(LootItemRandomChanceCondition.randomChance(chance))
                .add(LootItem.lootTableItem(GrowableOresItems.IRIDIUM_SHARD.get()))
                .apply(SetItemCountFunction.setCount(UniformGenerator.between(minCount, maxCount)).build());
    }
