...
import com.skniro.industrial_elixir.compat.rei.display.BlockCutterDisplay;
...
public class BlockCutterCategory implements DisplayCategory<BlockCutterDisplay> {
    ...
    public CategoryIdentifier<? extends BlockCutterDisplay> getCategoryIdentifier() {
        return BlockCutterDisplay.BlockCutter;
    }
    ...
    public Renderer getIcon() {
        return EntryStacks.of(GrowableOresBlocks.CUTTING_Block.get().asItem().getDefaultInstance());
    }

    @Override
    public List<Widget> setupDisplay(BlockCutterDisplay display, Rectangle bounds) {
