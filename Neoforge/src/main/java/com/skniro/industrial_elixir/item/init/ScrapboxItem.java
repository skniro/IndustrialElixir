...
public class ScrapboxItem extends Item {
    ...
    private static final Map<Item, Double> SCRAPBOX_DROPS = Map.ofEntries(
            ...
            Map.entry(GrowableOresItems.TIN_INGOT.get(), 0.0290),
            ...
            Map.entry(GrowableOresItems.TIN_DUST.get(), 0.0155),
            Map.entry(Items.DIAMOND, 0.0019),
            Map.entry(Items.BONE, 0.0193),
            Map.entry(GrowableOresItems.IRON_DUST.get(), 0.0135),
            ...
            Map.entry(GrowableOresItems.Raw_Tin.get(), 0.0135),
            ...
            Map.entry(GrowableOresItems.GOLD_DUST.get(), 0.0135),
            Map.entry(GrowableOresItems.COPPER_DUST.get(), 0.0155),
            Map.entry(Items.SLIME_BALL, 0.0116),
            Map.entry(Items.FEATHER, 0.0193),
            Map.entry(GrowableOresItems.RE_BATTERY.get(), 0.0135),
            Map.entry(Items.RAW_COPPER, 0.0135),
            Map.entry(Items.SOUL_SAND, 0.0193),
            Map.entry(GrowableOresItems.Rubber.get(), 0.0155),
