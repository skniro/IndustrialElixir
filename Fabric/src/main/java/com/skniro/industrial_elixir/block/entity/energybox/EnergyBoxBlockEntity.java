...
public class EnergyBoxBlockEntity extends BaseEnergyBoxBlockEntity {
    ...
    public EnergyBoxBlockEntity(BlockPos pos, BlockState state) {
        super(AlchemyBlockEntityType.EnergyBox_BLOCK_ENTITY, pos, state, 40000, EnergyTier.TIER1);
    }

    public EnergyBoxBlockEntity(BlockPos pos, BlockState state, int capacity, EnergyTier energyTier) {
        super(AlchemyBlockEntityType.EnergyBox_BLOCK_ENTITY, pos, state, capacity, energyTier);
    }
    ...
    public Component getDisplayName() {
        return switch (energyTier.ordinal()) {
            case 0 -> Component.translatable(FurnitureStrings.Energy_Box);
            case 1 -> Component.translatable(FurnitureStrings.Energy_Box_CESU);
            case 2 -> Component.translatable(FurnitureStrings.Energy_Box_MFE);
            case 3 -> Component.translatable(FurnitureStrings.Energy_Box_MFSU);
            default -> Component.translatable(FurnitureStrings.Energy_Box);
        };
    }
    ...
    public AbstractContainerMenu createMenu(int syncId, Inventory playerInventory, Player player) {
        return new EnergyBoxScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
