...
public class GrowableOresBlocks {
    ...
    public static final Block Macerator_Block =registerBlock("macerator", MaceratorBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block Compressor_Block =registerBlock("compressor", CompressorBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block MATTER_GENERATOR = registerBlock("matter_generator", MatterGeneratorBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block FLUID_GENERATOR = registerBlock("fluid_generator", FluidGeneratorBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block MetalFormerBlock =registerBlock("metalformer", MetalFormerBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));

    public static final Block COPPER_CABLE = registerBlock("copper_cable", (settings)-> new CableBlock(settings, ModContent.Cables.COPPER, "copper"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block TIN_CABLE = registerBlock("tin_cable", (settings)-> new CableBlock(settings, ModContent.Cables.TIN, "tin"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block GOLD_CABLE = registerBlock("gold_cable", (settings)-> new CableBlock(settings, ModContent.Cables.GOLD, "gold"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block HV_CABLE = registerBlock("hv_cable", (settings)-> new CableBlock(settings, ModContent.Cables.HV, "hv"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block GLASSFIBER_CABLE = registerBlock("glassfiber_cable", (settings)-> new CableBlock(settings, ModContent.Cables.GLASSFIBER, "glassfiber"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block INSULATED_TIN_CABLE = registerBlock("insulated_tin_cable", (settings)-> new CableBlock(settings, ModContent.Cables.INSULATED_TIN, "insulated_tin"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block INSULATED_COPPER_CABLE = registerBlock("insulated_copper_cable", (settings)-> new CableBlock(settings, ModContent.Cables.INSULATED_COPPER, "insulated_copper"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block INSULATED_GOLD_CABLE = registerBlock("insulated_gold_cable", (settings)-> new CableBlock(settings, ModContent.Cables.INSULATED_GOLD, "insulated_gold"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));
    public static final Block INSULATED_HV_CABLE = registerBlock("insulated_hv_cable", (settings)-> new CableBlock(settings, ModContent.Cables.INSULATED_HV, "insulated_hv"), BlockBehaviour.Properties.of().sound(SoundType.METAL).mapColor(MapColor.METAL).strength(1.0F, 8.0F));

    public static final Block COAL_GENERATOR = registerBlock("coal_generator", CoalGeneratorBlock::new, (BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops()));
    public static final Block NUCLEAR_REACTOR = registerBlock("nuclear_reactor", NuclearReactorBlock::new, (BlockBehaviour.Properties.of().strength(5.0F, 10.0F).requiresCorrectToolForDrops().sound(SoundType.METAL)));
    public static final Block SACRED_GENERATOR = registerBlock("sacred_generator", (settings) -> new SacredGeneratorBlock(settings, EnergyTier.TIER3, 100000L), (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    ...
    public static final Block CESU = registerBlock("cesu", s -> new EnergyBoxBlock(s, 300000, EnergyTier.TIER2), BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.5F));
    public static final Block MFE = registerBlock("mfe", s -> new EnergyBoxBlock(s, 4000000, EnergyTier.TIER3), BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F));
    public static final Block MFSU = registerBlock("mfsu", s -> new EnergyBoxBlock(s, 40000000, EnergyTier.TIER4), BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F));
    public static final Block CESU_CHARGE_PAD = registerBlock("charge_pad_cesu", s -> new ChargePadBlock(s, 300000, EnergyTier.TIER2), BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.5F));
    public static final Block MFE_CHARGE_PAD = registerBlock("charge_pad_mfe", s -> new ChargePadBlock(s, 4000000, EnergyTier.TIER3), BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F));
    public static final Block MFSU_CHARGE_PAD = registerBlock("charge_pad_mfsu", s -> new ChargePadBlock(s, 40000000, EnergyTier.TIER4), BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F));
    ...
    public static final Block INDUCTION_FURNACE = registerBlock("induction_furnace", InductionFurnaceBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.5F, 4.0F)));
    public static final Block HEAT_CENTRIFUGE = registerBlock("heat_centrifuge", HeatCentrifugeBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.5F, 4.0F)));
    ...
    public static final Block FLUID_TANK_BLOCK =registerBlock("fluid_tank", FluidTankBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F).noOcclusion().sound(SoundType.GLASS)));
    public static final Block Brew_Reactor_BLOCK =registerBlock("brew_reactor_tank", BrewReactorBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.GLASS)));
    public static final Block Ore_Washing_Block =registerBlock("ore_washing_block", OreWashingBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(1.5F).sound(SoundType.GLASS)));
    public static final Block Replicator =registerBlock("replicator", ReplicatorBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(4.0F, 5.0F).sound(SoundType.METAL)));

    public static final Block CHUNK_LOADER = registerBlock("chunk_loader", ChunkLoaderBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));

    public static final Block Electric_Heater_Block =registerBlock("electric_heater", ElectricHeaterBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block SOLID_FUEL_HEATER_GENERATOR = registerBlock("solid_fuel_heater_generator", SolidFuelHeaterBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
    public static final Block BLAST_FURNACE_BLOCK =registerBlock("blast_furnace", ModBlastFurnaceBlock::new, (BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(3.0F, 3.0F)));
