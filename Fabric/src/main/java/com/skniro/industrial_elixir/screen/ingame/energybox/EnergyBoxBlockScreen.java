...
public class EnergyBoxBlockScreen extends AbstractContainerScreen<EnergyBoxScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.fromNamespaceAndPath(IndustrialElixir.MOD_ID, "textures/gui/container/energybox/energy_box.png");

    public EnergyBoxBlockScreen(EnergyBoxScreenHandler handler, Inventory inventory, Component title) {
    ...
    private void renderEnergyArea(GuiGraphicsExtractor context, int x, int y) {
        context.blit(RenderPipelines.GUI_TEXTURED, GUI_TEXTURE, x + 72, y + 30, 176, 14, getScaledEnergyHeight(), 16,256,256);
    }
