...
public class ExtractorBlockScreen extends AbstractContainerScreen<ExtractorScreenHandler> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(IndustrialElixir.MOD_ID, "textures/gui/container/machine/extractor.png");

    public ExtractorBlockScreen(ExtractorScreenHandler handler, Inventory inventory, Component title) {
