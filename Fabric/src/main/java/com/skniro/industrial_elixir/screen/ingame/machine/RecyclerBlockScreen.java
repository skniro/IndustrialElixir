...
public class RecyclerBlockScreen extends AbstractContainerScreen<RecyclerScreenHandler> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(IndustrialElixir.MOD_ID, "textures/gui/container/machine/recycler.png");

    public RecyclerBlockScreen(RecyclerScreenHandler handler, Inventory inventory, Component title) {
