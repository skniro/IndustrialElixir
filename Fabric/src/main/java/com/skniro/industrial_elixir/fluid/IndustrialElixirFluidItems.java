...
public class IndustrialElixirFluidItems {
    ...
    public static final Item UU_CELL = registerItem("uu_cell",
            (properties)-> new FluidCellItem(properties, IndustrialElixirFluids.STILL_Fluid_UU), new Item.Properties().stacksTo(16));
    public static final Item AIR_CELL = registerItem("air_cell",
            (properties)-> new FluidCellItem(properties, IndustrialElixirFluids.STILL_Fluid_AIR), new Item.Properties().stacksTo(16));
