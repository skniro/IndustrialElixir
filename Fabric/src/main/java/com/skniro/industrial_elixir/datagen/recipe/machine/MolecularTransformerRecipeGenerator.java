    ...
    protected ModRecipeGenerator createRecipeProvider(HolderLookup.Provider wrapperLookup, RecipeOutput exporter) {
        return new ModRecipeGenerator(wrapperLookup, exporter) {
            ...
            public void buildRecipes() {
                ...
                createMolecularTransformer(Items.WOOL.red(), Items.REDSTONE_BLOCK,500000).save(output);
                createMolecularTransformer(Items.WOOL.blue(), Items.LAPIS_BLOCK,500000).save(output);
                ...
                createMolecularTransformer(Items.WOOL.yellow(), Items.GLOWSTONE,500000).save(output);
            }
        };
    }
