...
// 种子（可食用）
        ...
        register(GrowableOresItems.IRIDIUM_SHARD, 13, 0);
        register(GrowableOresItems.IRIDIUM_ORE, 120, 0);
        register(GrowableOresItems.IRIDIUM_PLATE, 520, 0);

        register(GrowableOresItems.IMPURE_SACRED_STONE, 31, 0);

        register(Items.SLIME_BALL, 133, 0);


        register(Item.byBlock(GrowableOresBlocks.MFSU), 11630, 0);;

        register(Items.PAPER, 3074, 0);

        register(GrowableOresItems.Scrap, 1, 0);;

        register(GrowableOresItems.Sticky_Resin, 6331, 0);
        register(GrowableOresItems.Rubber, 101, 0);
        register(Item.byBlock(GeneralBlocks.Rubber_SAPLING), 3572, 0);

        register(GrowableOresItems.Raw_SACRED, 16, 0);

        register(GrowableOresItems.SACRED_ESSENCE, 98, 0);
