...
public class ChestplateSlot extends BatteryChargeSlot {
    public ChestplateSlot(Container inventory, int index, int x, int y, EnergyTier energyTier) {
    ...
    public boolean mayPlace(ItemStack stack) {
        ...
        if (equippable.slot() != EquipmentSlot.CHEST) return false;
