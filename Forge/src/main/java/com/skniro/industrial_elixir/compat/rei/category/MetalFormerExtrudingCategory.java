...
import com.skniro.industrial_elixir.compat.rei.display.MetalFormerExtrudingDisplay;
...
public class MetalFormerExtrudingCategory implements DisplayCategory<MetalFormerExtrudingDisplay> {
    ...
    public CategoryIdentifier<? extends MetalFormerExtrudingDisplay> getCategoryIdentifier() {
        return MetalFormerExtrudingDisplay.MetalFormerExtruding;
    }
    ...
    @Override
    public List<Widget> setupDisplay(MetalFormerExtrudingDisplay display, Rectangle bounds) {
