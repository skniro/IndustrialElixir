...
public class MetalFormerCuttingCategory implements IRecipeCategory<RecipeHolder<MetalFormerCuttingCraftingRecipe>> {
    ...
    public MetalFormerCuttingCategory(IGuiHelper helper) {
    ...
    @Override
    public IRecipeType<RecipeHolder<MetalFormerCuttingCraftingRecipe>> getRecipeType() {
        return TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<MetalFormerCuttingCraftingRecipe> recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(RecipeHolder<MetalFormerCuttingCraftingRecipe> recipe, IRecipeSlotsView slots, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
