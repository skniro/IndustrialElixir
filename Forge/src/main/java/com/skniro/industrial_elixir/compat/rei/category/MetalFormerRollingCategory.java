...
import com.skniro.industrial_elixir.compat.rei.display.MetalFormerRollingDisplay;
...
public class MetalFormerRollingCategory implements DisplayCategory<MetalFormerRollingDisplay> {
    ...
    @Override
    public CategoryIdentifier<? extends MetalFormerRollingDisplay> getCategoryIdentifier() {
        return MetalFormerRollingDisplay.MetalFormerRolling;
    }
    ...
    public Renderer getIcon() {
        return EntryStacks.of(GrowableOresBlocks.MetalFormerBlock.get().asItem().getDefaultInstance());
    }

    @Override
    public List<Widget> setupDisplay(MetalFormerRollingDisplay display, Rectangle bounds) {
