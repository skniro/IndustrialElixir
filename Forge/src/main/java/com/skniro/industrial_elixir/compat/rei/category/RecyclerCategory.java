...
import com.skniro.industrial_elixir.compat.rei.display.RecyclerDisplay;
...
public class RecyclerCategory implements DisplayCategory<RecyclerDisplay> {
    public static final Identifier TEXTURE = Helper.id(
            "textures/gui/container/machine/recycler.png");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(GrowableOresBlocks.RECYCLER_Block.get().asItem().getDefaultInstance());
    }
    ...
    public List<Widget> setupDisplay(RecyclerDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createDrawableWidget((context, mouseX, mouseY, delta) -> {
            ...
            context.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, startPoint.x + 72, startPoint.y + 34, 190, 0, progress, 16, 256, 256);
        }));
